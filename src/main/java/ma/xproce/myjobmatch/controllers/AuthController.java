...
//        // The login functionality is already handled by UsernamePasswordAuthenticationFilter
//        // When a request is sent to /login, Spring Security automatically processes it
//        return new ResponseEntity<>("Login request processed by Spring Security", HttpStatus.OK);
//    }
